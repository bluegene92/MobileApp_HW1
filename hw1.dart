...
void main() {
  ...
  List<Feature> allFeatures = [
    ...person.getLikeFeatures(),
    ...person.getUnlikeFeatures()
  ];
...
class Student extends Person {
  ...
  Student(this.firstName, this.lastName, this.age, this.schoolYear, this.gpa)
...
class FeatureReviewPrinter {
  static printFeature(List<Feature> features) {
    ...
    for (Feature feature in features) {
      ...
      print(
          """${featureNamePad} ${featureLikePad.padRight(8)} ${featureReviewPad}""");
    }
  }
}
